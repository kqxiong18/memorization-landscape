...
extraction metrics, the geometric-mean reliability is
...
claim.
The same logic applies to scale: at 1B parameters, cross-family
$\tau \approx 0.00$ across all duplication levels, while at 8B intermediate
duplication $\tau \approx 0.3$--$0.4$; a single shared construct with fixed
reliability would yield the same true-score correlation at both scales.
